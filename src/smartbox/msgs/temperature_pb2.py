...
_TEMPERATURECONTROLLER = _descriptor.ServiceDescriptor(
  ...
  full_name='smartbox.TemperatureController',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='smartbox.TemperatureController.panel_temperature',
    index=0,
